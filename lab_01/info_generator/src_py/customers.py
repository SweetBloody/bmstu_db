...
def generate_customers_showroom(customers_list, showroom_list):
    cust_show_list = []
    ...
    for i in range(len(customers_list)):
        ...
        for elem in arr:
            cust_show_list.append([customers_list[i][0], elem])
...
def generate_customers(number):
    ...
    for i in range(number):
        ...
        if sex == 0:
            ...
            sex = 'женский'
            age = randint(20, 60)
        customers_list.append([i + 1, surname, name, otch, age, sex])
